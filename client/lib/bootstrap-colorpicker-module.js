        ...
        return {
            ...
            link: function ($scope, elem, attrs, ngModel) {
                var
                    ...
                    absolutePosition = angular.isDefined(attrs.colorpickerAbsolutePosition) ? attrs.colorpickerAbsolutePosition : false,
                ...
                if (absolutePosition) {
                    colorpickerTemplate.addClass('colorpicker-absolute-position');
                }
                ...
                var getColorpickerTemplatePosition = function() {
                    ...
                    if (position === 'top') {
                        ...
                        positionValue = {
                            'top': positionOffset.top + ((elem[0].offsetHeight-colorpickerTemplate[0].offsetHeight) / 2),
                            'left': positionOffset.left + ((elem[0].offsetWidth-colorpickerTemplate[0].offsetWidth+40) / 2)
                        };
                    }
                    return {
